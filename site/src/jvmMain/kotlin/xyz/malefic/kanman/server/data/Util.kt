...
private val dbPath = System.getProperty("DB_PATH") ?: System.getenv("DB_PATH") ?: "kanman.db"
...
fun initDatabase() {
    ...
    transaction {
        addLogger(SQLKermit)
        SchemaUtils.create(Users, AuthTokens, Boards, BoardEvents, StickyNotes, AssignedUsers, BoardUsers, Invitations)
    }
}
